...
status.write(filename='KATSIROUMBA_HWK3_OPT_OUTPUTS.json', format='json')

# pyomo solve KATSIROUMBA_HWK_3_OPT.py --solver=glpk    # use this
# pyomo solve KATSIROUMBA_HWK_3_OPT.py --solver=gurobi